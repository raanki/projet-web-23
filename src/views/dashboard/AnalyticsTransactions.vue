    ...
    <VCardText>
      <VList class="loan-list">
        ...
        >
          ...
          <template #append>
            <VListItemAction>
              <span :class="{'text-success': loan.status === 'On time', 'text-error': loan.status === 'Late'}">
                {{ loan.status }}
              </span>
            </VListItemAction>
          </template>
